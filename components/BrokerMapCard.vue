      ...
      >
        ...
        >
          ...
          <div class="row items-center">
            ...
            <nuxt-link v-if="!noLink" :to="`/operational-map/detail`" class="text-dark-blue text-c-1 col-auto border-l border-l-dark-blue items-center flex gap-2 font-medium">
              More Details
