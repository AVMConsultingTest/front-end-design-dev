...
export default Vue.extend({
  ...
  data () {
    return {
      ...
      //   carrier_id: 22,
      //   carrier_score: 20,
      //   unsafe_driving_measure: 12,
      //   unsafe_driving_percentile: 32,
      //   unsafe_driving_oos: 2,
      //   driver_fitness_measure: 8,
      //   driver_fitness_percentile: 4,
      //   driver_fitness_oos: 0,
      //   crash_indicator_measure: 11,
      //   crash_indicator_percentile: 6,
      //   crash_indicator_oos: 1,
      //   hos_compliance_measure: 8,
      //   hos_compliance_percentile: 2,
      //   hos_compliance_oos: 0,
      //   vehicle_maintenance_measure: 5,
      //   vehicle_maintenance_percentile: 6,
      //   vehicle_maintenance_oos: 1,
      //   substance_alcohol_measure: 3,
      //   substance_alcohol_percentile: 6,
      //   substance_alcohol_oos: 1,
      //   hm_compliance_measure: 11,
      //   hm_compliance_percentile: 2,
      //   hm_compliance_oos: 8,
      //   updated_date: '30/02/0013'
      // } as any
    }
  },
  computed: {
    ...
    safetyMetrics (): SafetyMetricsSummary {
      ...
      //   id: 1,
      //   carrier_id: 22,
      //   oos_driver_change_per: 12,
      //   oos_driver_curr_month: 32,
      //   oos_driver_prev_month: 76,
      //   oos_hazmat_change_per: 76,
      //   oos_hazmat_curr_month: 56,
      //   oos_hazmat_prev_month: 72,
      //   oos_vehicle_change_per: 87,
      //   oos_vehicle_curr_month: 21,
      //   oos_vehicle_prev_month: 51,
      //   crash_indicator_change_per: 52,
      //   crash_indicator_curr_month: 12,
      //   crash_indicator_prev_month: 31,
      //   hm_compliance_change_per: 42,
      //   hm_compliance_curr_month: 51,
      //   hm_compliance_prev_month: 21,
      //   hos_compliance_change_per: 81,
      //   hos_compliance_curr_month: 41,
      //   hos_compliance_prev_month: 33,
      //   substance_alcohol_change_per: 11,
      //   substance_alcohol_curr_month: 14,
      //   substance_alcohol_prev_month: 19,
      //   updated_date: '30/02/0013'
      // }
    },
