<template>
  <div class="w-full">
    <PageHeader title="HM Compliance Details" class="mb-10" @search="''" @goback="$router.go(-1)" />
    <div class="row mb-5">
      <div class="col-12">
        <Table
          title="HM Compliance"
...
export default Vue.extend({
    ...
    return {
      ...
      testData: [
        ...
        },
        {
          ...
          date: '2/12/2023',
          violation_state: 'ID',
          violation_report_number: '90OP65TBC5',
          upload_document: 'broker.pdf',
          inspection_level: 2,
          driver_name: 'Elizabeth Morgan',
          asset_id: 'Unit 2',
        ...
        },
        {
          ...
          date: '12/12/2024',
          violation_state: 'LA',
          violation_report_number: '71BN62DF54D',
  ...
  computed: {
    hms (): VehiclesMaintenance[] {
      const aData = (this.$store.getters['vehicles/hms'])
      return aData.length > 0 ? aData : this.testData
    },
    totalPageCount (): number {
      return (this.$store.getters['vehicles/hmPageCount'])
    }
  },
  mounted () {
  ...
  methods: {
    ...mapActions({
      getHms: (action, page) => action('vehicles/getHms', page)
    }),
    getKey () {
