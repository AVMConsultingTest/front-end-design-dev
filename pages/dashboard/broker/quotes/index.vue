<template>
  <div class="w-full">
    <Drawer ref="drawer" />
    <PageHeader title="Quotes" class="mb-10" :show-date="false">
      <template #actions>
    ...
    <div v-if="mode==='list'" key="list">
      ...
      >
        ...
        <template #item-last_new_quote="{ data, index }">
          <div class="row">
            <div class="col-auto">
              <span class="block">
                ${{ data[index].last_quote }} / ${{ data[index].new_quote }}
              </span>
            </div>
          </div>
        </template>
