  ...
  <div class="h-full">
    <div class="pl-24 pr-28">
      ...
      <Form fclass="row my-2" @send="handleSubmit">
        ...
        <div class="col-6 mb-6">
          <Input
            v-model.number="request.acceptance_rate"
            name="acceptance"
            type="number"
            label="Acceptance (%)"
          />
  ...
  methods: {
    ...
    handleSubmit () {
      this.addDriver({
        ...
        driver_avatar: 1,
        driver_live_location: 'Texas',
        driver_score: 1,
        hire_date: moment().toISOString(),
        driver_dob: moment().toISOString(),
        payment_rate: 1
