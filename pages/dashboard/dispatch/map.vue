...
export default {
  ...
  computed: {
    dispatch () {
      // return (this.$store.getters['dispatch/dispatch'])
      return {
        total_loads_curr_month: 130,
        upcoming_loads: 20,
        unassigned_loads: 12,
        delayed_loads: 2,
        intransit_loads: 5,
        total_drivers_curr_month: 80,
        active_drivers: 45,
        offduty_drivers: 12,
        underperforming_drivers: 2,
        bestperforming_drivers: 5,
        total_trucks_curr_month: 76,
        enroute_trucks: 45,
        ready_trucks: 12,
        inservice_trucks: 6,
        placeholder_trucks: 2,
        total_trailers_curr_month: 64,
        enroute_trailers: 20,
        ready_trailers: 12,
        inservice_trailers: 2,
        placeholder_trailers: 5,
        total_drivers_prev_month: 25
