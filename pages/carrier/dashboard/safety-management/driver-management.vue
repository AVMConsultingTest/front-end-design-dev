...
export default Vue.extend({
  ...
  data () {
    ...
    return {
      ...
      driverWidgets: [
        { title: 'Active Drivers', value: 'active_drivers', date: false },
        { title: 'Dispatched Drivers', value: 'dispatched_drivers', date: false },
        { title: 'Drivers on Vacation', value: 'drivers_on_vacation', date: false },
        { title: 'Drivers with Overdue Documents', value: 'drivers_with_overdue_documents', date: false },
        { title: 'Drivers with Pending Documents', value: 'drivers_with_pending_docs', date: false },
        { title: 'Drug Test Off-Duty Drivers', value: 'drug_test_off_duty_drivers', date: false },
        { title: 'Drug Tests', value: 'drug_tests', date: false },
        { title: 'High Risk Drivers', value: 'high_risk_drivers', date: false },
        { title: 'Off-Duty Drivers', value: 'off_duty_drivers', date: false },
        { title: 'On-Duty Drivers', value: 'on_duty_drivers', date: false },
        { title: 'Outstanding Drivers', value: 'outstanding_dvers', date: false },
        { title: 'Scheduled Trainings', value: 'scheduled_trainings', date: false }
      ],
      driverHeaders: {
        first_name: {
          label: 'Driver Name',
