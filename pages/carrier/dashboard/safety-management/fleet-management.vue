      ...
      <div class="row mb-5">
        ...
        <div class="col-6">
          <widget :no-shadow="false" :no-border="true" class="h-full">
            ...
            <div v-if="!expiringPermitsSummary.length"  class="flex justify-center items-center relative bottom-[40%] text-">
              
                <span v-if="showDelayed" class="text-md font-normal">
                  There are no expiring permits in the next 30 days. 
                </span>
...
export default {
  ...
  computed: {
    ...
    const data = this.$store.getters['expiringPermitsSummary/carrierSummary'];
    this.donutOptions.labels.push(...Object.keys(data));
