          ...
          <div slot="body" class="row flex items-center justify-center pt-7 px-2">
            <div class="col-12 items-center justify-center my-0">
              ...
              <Form fclass="row my-2">
                ...
                <div class="row mb-5 mt-3 ml-1 items-center">
      ...
      <div class="flex col-6 my-8 mr-8">
        <div class="bill-card w-full bg-white rounded-xl px-6 py-7 border border-grey-blue-100 dark:border-b-gray-60">
          ...
          <div class="mt-12 flex justify-end">
            <div class="cursor-pointer mb-1 text-base font-medium text-purple-700 dark:text-purple-500">
              Upgrade plan
            </div>
          </div>
        </div>
          ...
          <div class="flex mt-6 rounded-xl px-6 py-7 border border-grey-blue-100 dark:border-b-gray-60">
            ...
            <div class="flex flex-col ml-3">
              ...
              <div class="message flex mt-2">
                <Icon icon="mail-01" :disable-fill="false" class="w-5 h-5 " />
                <span class="font-normal text-b-4">Ebilling@untitledui.com</span>
              </div>
            </div>
            <div class="cursor-pointer ml-auto rounded-xl border border-black dark:border-b-gray-60 h-12 w-20 text-center flex items-center justify-center">
              <button>Edit</button>
            </div>
          </div>
        </div>
